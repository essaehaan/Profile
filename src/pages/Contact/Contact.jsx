...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "8a90b2ca-cf44-4299-ad1c-0bfd15a721d7"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">developeressaehaan@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Garden east Karachi</p>
                  </div>
                </div>
              </div>
            </div>
